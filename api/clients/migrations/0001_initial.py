    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'Мужчина'), ('F', 'Женщина'), ('U', 'Не указан')], default='U', max_length=1)),
                ('avatar', models.ImageField(blank=True, upload_to='clients/')),
